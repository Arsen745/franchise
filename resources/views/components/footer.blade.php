    ...
    <div class="content-footer">
        <div class="container">
            <form class="form" action="{{ route('feedback.store') }}" method="POST">
                ...
                <div class="check">
                    <input type="hidden" name="consent_pd" value="0">
                    <input name="consent_pd" type="checkbox" value="1" required>
                    <label>Согласие обработки ПД</label>
                </div>
                <div class="btn-description">
                    <button type="submit">Оставить заявку</button>
                    <p class="description-footer">В ближайшее время с Вами свяжется наш менеджер и проконсультирует по
                        всем вопросам</p>
                    <p class="email">Почта для связи: <a href="mailto:franshiza-kulikov@mail.ru">franshiza-kulikov@mail.ru</a>
                    </p>
                </div>
            </form>
        </div>
